function [PaMode] = Photostability_Read_Single_base(baseFolder, baseFilename, iFrames, modeName, varargin)
...
try
  ...
  param = Single_XML_Photostability(baseFolder, fnameXml, '.pamode');
  ...
  if (~exist(fname, 'file'))
      fname = [baseFilename '.raw.3d.pamode'];
  end
